        ...
        <form action="{{ route('Proveedores.buscar') }}" method="get">
            <div class="row">
                <div class="col-12">
                    ...
                    <input type="search" class="form-control" id="exampleInputEmail1" value="{{ $buscar }}"
                        name="buscar">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('Proveedores.edit', $item->id_proveedor) }}"
                                    class="waves-effect waves-light btn-small">Editar</a>
                                <button type="button" class="waves-effect waves-light btn-small" data-bs-toggle="modal"
                                    data-bs-target="#ModalEliminarProveedor{{ $item->id_proveedor }}">
